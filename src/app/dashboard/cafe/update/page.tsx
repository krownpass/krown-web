...
export default function UserUpdatePage() {
  ...
  return (
    ...
    >
      ...
      {/* RIGHT SIDE IMAGES + COVER IMAGE SECTION */}
      <div className="space-y-10">
        {/* COVER IMAGE SECTION */}
        <div className="space-y-6">
          <div className="flex justify-between items-center">
            <h2 className={`${bebasNeue.className} text-3xl`}>Cover Image</h2>
            <span className="text-sm">
              {data?.cafe?.cover_image ? "1/1 uploaded" : "0/1 uploaded"}
            </span>
          </div>
            ...
            <>
              ...
              <Input
                ...
                onChange={(e) => {
                  ...
                  api
                    .post(`/cafes/cover/upload`, formData)
                    .then(() => {
          ...
          {data?.cafe?.cover_img && (
            ...
            >
              ...
              <button
                onClick={() =>
                  api
                    .delete(`/cafes/cover/${user!.cafe_id}`, {
                      data: {
                        cafe_id: user!.cafe_id,
